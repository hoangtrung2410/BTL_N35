...
public class gui65 {
    ...
    void initialize() {
        ...
        showcategory.setOnMouseClicked(event -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("gui65v2.fxml"));
                Parent gui65v2Parent = loader.load();
                Scene gui65v2Scene = new Scene(gui65v2Parent);
                gui65v2 controller = loader.getController();
